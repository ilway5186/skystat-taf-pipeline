...
import static com.skystat.core.domain.vo.weather.field.phenomena.WeatherPhenomenonGroup.*;
...
public enum WeatherPhenomenon implements WeatherCode {
  ...
  public static WeatherPhenomenon fromSymbol(String symbol) {
    for (WeatherPhenomenon phenomenon : values()) {
      if (phenomenon.symbol.equals(symbol)) {
        return phenomenon;
      }
    }
    throw new IllegalArgumentException("No WeatherPhenomenon with symbol: " + symbol);
  }
