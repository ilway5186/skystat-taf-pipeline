...
public record Visibility(double value, LengthUnit unit, boolean isP6SM, boolean isCavok) {
	...
	public static Visibility p6sm() {
		return new Visibility(MAX_VISIBILITY_MILE, LengthUnit.SM, true, false);
	}

	public static Visibility cavok() {
		return new Visibility(MAX_VISIBILITY_METER, LengthUnit.METER, false, true);
	}
